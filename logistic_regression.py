...
model_filename = 'logistic_regression_model.pkl'  # Update to your logistic regression model filename
...
with open("logistic_regression_recommendation.txt", "w") as file:
